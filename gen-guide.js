...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      numbered([run('Select '), bold('ai-insight-panel.zip'), run(' from your files and click '), bold('Save'), run('.')]),
      numbered('The extension will appear in the list as "AI Insight Panel". It is now available to all users on the tenant.'),
      sp(160),
